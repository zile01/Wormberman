...
//   Serial.println(sizeof(N64_raw_dump));


    if(N64_raw_dump[0]){
        Serial.print("A");  
    } else if(N64_raw_dump[1]){
        Serial.print("B");
    } else if(N64_raw_dump[2]){
        Serial.print("Z");
    } else if(N64_raw_dump[3]){
        Serial.print("S");
    } else if(N64_raw_dump[4]){
        Serial.print("U");
    } else if(N64_raw_dump[5]){
        Serial.print("D");
    } else if(N64_raw_dump[6]){
        Serial.print("L");
    } else if(N64_raw_dump[7]){
        Serial.print("R");
    }
